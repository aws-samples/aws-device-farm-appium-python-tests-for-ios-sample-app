...
1. Start the Appium server.
    ...
    2. Edit the [start-appium-ios.sh](./start-appium-ios.sh) script to include your app's absolute path and your device's UDID.
    3. Run [start-appium-ios.sh](./start-appium-ios.sh) to start the Appium server locally.
2. Navigate into your workspace project directory in the terminal and activate the virtualenv.
...
Follow these [instructions](http://docs.aws.amazon.com/devicefarm/latest/developerguide/test-types-ios-appium-python.html#test-types-ios-appium-python-upload) and upload **test_bundle.zip** on Step 9.
